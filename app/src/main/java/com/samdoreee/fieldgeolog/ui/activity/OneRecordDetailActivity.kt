...
class OneRecordDetailActivity : AppCompatActivity(), CoroutineScope {
            ...
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    if (personalRecordResponse != null) {
                        ...
                        article_title.text = personalRecordResponse.recordTitle
                        ...
                        article_date.text = personalRecordResponse.createDT.take(10)
                        weather.text =
                            personalRecordResponse.spotResponseDTOList[0].weatherInfo

                        val spotlist:List<SpotResponse> = personalRecordResponse.spotResponseDTOList
                        ...
                        for(i in 1..n){
                            ...
                            s3FileDownloader.downloadFile(now_pictures[i-1].fileName, object : S3FileDownloader.DownloadListener {
                                override fun onDownloadCompleted(file: File?) {
                                    ...
                                    Glide.with(this@OneRecordDetailActivity)
                                        .load(file)
